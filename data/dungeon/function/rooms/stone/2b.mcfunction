...
# normal
execute if score @s rng matches 3 run data merge entity @s {data:{name:"basic-dungeon-2",credit:"Circuit"}}
execute if score @s rng matches 4 run data merge entity @s {data:{name:"piston-parkour",credit:"Zero"}}
